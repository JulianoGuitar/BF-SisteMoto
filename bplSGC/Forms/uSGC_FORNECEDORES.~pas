...
begin
  ...
  begin
    ...
    begin
       MessageBox(Handle, pchar('Fornecedor estrangeiro não pode ser Brasileiro.'), 'Aviso', MB_ICONWARNING);
       edtCodPais.SetFocus;
       Exit;
    end;
    ...
    begin
      MessageBox(Handle, pchar('Informe o Tipo de Contribuição do Fornecedor.'), 'Aviso', MB_ICONWARNING);
