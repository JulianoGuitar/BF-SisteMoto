...
begin
{não tem autoincremento nos UFs
...
begin
 if (not cds.Active) or cds.IsEmpty then exit;
  ...
  begin
    ...
    Limpa_Campos;
    DefinicaoCampos.Add('D2;20;D;;COD_UF;Cód.UF');
    DefinicaoCampos.Add('D0;20;E;;UF;Módulo');
...
begin
  ...
  begin
    MessageBox(Handle, pchar('Informe o código da UF.'), 'Aviso', MB_ICONWARNING);
    bfdbEdit1.SetFocus;
    Exit;
  end;
